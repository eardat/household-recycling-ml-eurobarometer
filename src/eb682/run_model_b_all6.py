...
def main():
    ...
    result, info = run_experiment(
        ...
        experiment_label="EB68.2 Model B",
        X=X,
        y=y,
        ...
        oversample=False,
        output_csv=RESULTS / "results_EB68_2_Model_B_ALL6.csv",
    )
    save_best_figures(
        result,
        info,
        FIGURES / "confusion_EB68_2_Model_B_best_ALL6.png",
        FIGURES / "roc_EB68_2_Model_B_best_ALL6.png",
    )
    return result
